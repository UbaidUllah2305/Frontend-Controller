  ...
  return (
    <AlertDialog open={ModalOpen} onOpenChange={setModalOpen}>
      ...
      <AlertDialogContent className="border border-border">
        <AlertDialogHeader>
          <AlertDialogTitle>Assign Metadata to this Product</AlertDialogTitle>
          <AlertDialogDescription>
...
export default AssignMetaDataToProduct;
